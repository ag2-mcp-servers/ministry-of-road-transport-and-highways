...
class CertificateParameters1(BaseModel):
    ...
    swd_name: str = Field(
        ..., description='Son / Wife / Daughter of', examples=['Person Name']
    )


class FitcerCertificatePostRequest(BaseModel):
...
class FitcerCertificatePostResponse(BaseModel):
...
class FitcerCertificatePostResponse1(BaseModel):
...
class FitcerCertificatePostResponse2(BaseModel):
...
class FitcerCertificatePostResponse3(BaseModel):
...
class FitcerCertificatePostResponse4(BaseModel):
...
class FitcerCertificatePostResponse5(BaseModel):
...
class FitcerCertificatePostResponse6(BaseModel):
...
class CertificateParameters3(BaseModel):
    ...
    swd_name: str = Field(
        ..., description='Son / Wife / Daughter of', examples=['Veer Pratap Singh']
    )
...
class VhinscCertificatePostRequest(BaseModel):
...
class VhinscCertificatePostResponse(BaseModel):
...
class VhinscCertificatePostResponse1(BaseModel):
...
class VhinscCertificatePostResponse2(BaseModel):
...
class VhinscCertificatePostResponse3(BaseModel):
...
class VhinscCertificatePostResponse4(BaseModel):
...
class VhinscCertificatePostResponse5(BaseModel):
...
class VhinscCertificatePostResponse6(BaseModel):
...
class CertificateParameters4(BaseModel):
    ...
    swd_name: str = Field(
        ...
        examples=['Person Name. As per your Vehicle Registration Certificate'],
    )


class VhtaxCertificatePostRequest(BaseModel):
...
class VhtaxCertificatePostResponse(BaseModel):
...
class VhtaxCertificatePostResponse1(BaseModel):
...
class VhtaxCertificatePostResponse2(BaseModel):
...
class VhtaxCertificatePostResponse3(BaseModel):
...
class VhtaxCertificatePostResponse4(BaseModel):
...
class VhtaxCertificatePostResponse5(BaseModel):
...
class VhtaxCertificatePostResponse6(BaseModel):
